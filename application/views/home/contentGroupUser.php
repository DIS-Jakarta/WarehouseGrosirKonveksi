        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
			...
			<div class="form-group">
              ...
              <div class="col-md-9">
				<div><input type="checkbox" name="isView" id="isView" style="margin-top:8px;"><label class="control-label col-md-3">View</label></div>
                <div><input type="checkbox" name="isAdd" id="isAdd" style="margin-top:8px;"><label class="control-label col-md-3">Add</label></div>
				<div><input type="checkbox" name="isUpdate" id="isUpdate" style="margin-top:8px;"><label class="control-label col-md-3">Edit</label></div>
				<div><input type="checkbox" name="isDelete" id="isDelete" style="margin-top:8px;"><label class="control-label col-md-3">Delete</label></div>
              </div>
            </div>
          </div>
        </form>
